      ...
      cpuStat.usagePercent(function (e, percent, seconds) {
          try {
              ...
              const botinfo = new Discord.MessageEmbed()
                  ...
                  .addField("⌚️ Uptime ", `\`${formatDuration(client.uptime)}\``, true)
                  .addField("\u200b", `\u200b`, true)
                 ...
                 .setFooter('Hùng', 'https://cdn.discordapp.com/attachments/893077644311142450/896571458808082502/istockphoto-1036106190-612x612.jpeg');
              message.reply({
                  embeds: [botinfo]
              });
